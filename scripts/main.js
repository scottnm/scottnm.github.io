const data = {
    ...
    "projectData": [
        ...
        },
        {
            'title': 'Scrapewood',
            'dates': 'Spring 2021',
            'description': 'Assembled the Achewood web comic into an e-reader compatible EPUB',
            'image': 'site_images/scrapewood_on_reader.webp',
            'read': 'pages/bespoke/scrapewood/2024_01_07_scrapewood.html',
            'tools': 'rust'
        },
        {
            'title': 'Lost-n-found',
        ...
        */
        {
            ...
            'read': 'pages/bespoke/treachery/2024_01_07_treachery.html',
